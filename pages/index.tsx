            ...
            <section>
                ...
                <div className={styles.list}>
                    <span>
                        ...
                        of a web application generating 60% of company revenue. I love my experience so far here as I've been trusted with
                        the freedom to explore new libraries and create prototypes.
                    </span>
                    ...
                    <span>
                        ...
                        <Notation config={NotationConfigs.underline}>threeDays</Notation>, I was able to learn the basics of creating static
                        websites. This internship helped me understand the importance of managing a clean codebase. At{' '}
                        <Notation config={NotationConfigs.underline}>Trips4Trade</Notation> however, I learned a new set of tools with using
                        WordPress. I gained experience pushing changes up to different environments, refactoring existing databases, as well
                        as using third-party plugins.
                    </span>
                </div>
            </section>
